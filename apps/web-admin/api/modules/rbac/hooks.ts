...
export function useAdminPermissions() {
  return useQuery({
    ...
    queryFn: () =>
      getApi<ApiResponse<Permission[]>>("/api/v1/admin/permissions"),
  });
}
...
export function useAdminServices() {
  return useQuery({
    ...
    queryFn: () =>
      getApi<ApiResponse<ServiceConfig[]>>("/api/v1/admin/services"),
  });
}
...
export function useUpdateServiceConfig() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      putApi<ApiResponse<ServiceConfig>>(
        `/api/v1/admin/services/${encodeURIComponent(key)}`,
        {
          value,
          description,
        },
