...
export function BillingCheckoutModal({
  ...
  const [selectedMethod, setSelectedMethod] =
    useState<BillingPaymentMethod>("bakong");
    ...
    () => [
      {
        ...
        iconClassName:
          "bg-[#E5282A] text-white text-[10px] font-semibold tracking-tight",
        icon: "KHQR",
      },
      {
        id: "stripe",
  ...
  return (
    <BillingModalShell
      ...
      onClose={onClose}
      dismissible={!busy}
      ariaLabelledBy="billing-checkout-title"
    >
      {plan && (
        <>
          <div className="relative border-b border-white/[0.08] bg-[#1a1f2e] px-6 pb-5 pt-6">
            ...
            <div className="flex items-end gap-1.5">
              ...
              <span className="text-[40px] font-semibold leading-none tracking-tight text-white">
                {formatCheckoutAmount(plan.price)}
              </span>
          ...
          <div className="px-6 py-6">
            <p className="mb-4 text-[10px] font-semibold uppercase tracking-[0.14em] text-white/30">
              {labels.selectPayment}
            </p>
            <motion.div
              variants={modalOptionStagger}
              initial="initial"
              animate="animate"
                ...
                return (
                  <motion.button
                    ...
                    className={[
                      ...
                      selected
                        ? "border-[#5B7FFF]/70 bg-[#5B7FFF]/10 ring-1 ring-[#5B7FFF]/25"
                  ...
                  >
                    ...
                    <span
                      className={[
                        ...
                        selected
                          ? "border-[#5B7FFF] bg-[#5B7FFF] text-white"
