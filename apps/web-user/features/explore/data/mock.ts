...
export const MOCK_AVATARS: ExploreAvatar[] = [
  {
    ...
    name: "Alex — Studio",
    style: "professional",
    gradient: "linear-gradient(160deg, #1e3a5f, #0f172a)",
  },
  {
    id: "2",
    name: "Mina — Friendly",
    style: "casual",
    gradient: "linear-gradient(160deg, #7c3aed, #4c1d95)",
  },
  {
    id: "3",
    name: "Kai — Presenter",
    style: "professional",
    gradient: "linear-gradient(160deg, #0369a1, #0c4a6e)",
  },
  {
    id: "4",
    name: "Luna — Animated",
    style: "animated",
    gradient: "linear-gradient(160deg, #db2777, #7e22ce)",
  },
  {
    id: "5",
    name: "Jordan — Casual",
    style: "casual",
    gradient: "linear-gradient(160deg, #059669, #064e3b)",
  },
  {
    id: "6",
    name: "Nova — Animated",
    style: "animated",
    gradient: "linear-gradient(160deg, #ea580c, #9a3412)",
  },
];
