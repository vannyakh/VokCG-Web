      ...
      {error && (
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-slate-950/95 text-white p-4 text-center">
          ...
          <p className="text-xs text-white/50 mt-1">
            Please verify the connection or media source path.
          </p>
        </div>
      )}
            ...
            <div className="flex items-center justify-between mt-1.5">
              <div className="flex items-center gap-2">
                <button
                  ...
                  onClick={togglePlay}
                  className="flex h-7 w-7 items-center justify-center rounded-full text-white/90 hover:text-white hover:bg-white/15 transition-colors"
                >
