...
export function Page({
  ...
  return (
    <div
      ref={rootRef}
      className={joinClasses('page flex min-h-0 w-full flex-col', fill && 'h-full', widthClass, className)}
    >
      {showHeader && (
        <div
          ref={headerRef}
      ...
      {hasNode(footer) && (
        <div
          ref={footerRef}
          className={joinClasses('page-footer w-full shrink-0 border-t border-default', footerClass)}
        >
          <div
            className={joinClasses(
              'page-footer-inner',
